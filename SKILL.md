...
- 标准规范专项训练库：`assets/questions/standards_training.json`，当前结构化 7/16 个标准/法规文档、494 条条款、74 道专项训练题；其余 9 个标准规范 PDF 因需 OCR 或文本过少暂不生成训练题。
...
- 全资料检索索引：`assets/search/index.json`，当前 11371 个本地资料片段，覆盖教材章节、正式题库、案例、真题、标准规范、内部资料、模拟题库、VIP、冲刺资料、训练化资产。
